...
export class UserProfile extends Component {
  ...
  //Ask Ajay to modify this method in master
  handleEditProfile = async (e) => {
    ...
    axios
      .put(dbUrl, user)
      .then((resp) => {
        console.log("PUT request: " + resp.data.firstName);
  ...
  handleLoginAuthorization = () => {
    ...
    if (islogin == null) {
      ...
      //if(this.state.alertProfile){
      console.log("Test isLogin success: " + this.state.alertProfile);
      //alert.show("Please login");
      // return(
      // <Alert variant="danger" onClose={() => this.setState({alertProfile: false})} style={{color: "red"}} dismissible>
      // <Alert.Heading style={{fontSize: "14px"}}>You need to Login to access this feature</Alert.Heading>
      // </Alert>
  ...
  //  Sanjana's code here for editing form
  handleInputChange = (e) => {
    e.preventDefault();
  ...
  render() {
    ...
    return (
      <div className="Homepage">
        ...
        >
          {/* <h2 style = {{marginTop: "200px"}}>YOUR PROFILE</h2> */}
          <header>
        ...
        {/* *********************************SECTION 2******************************************** */}
        {/* <section className="bg2-pattern">
          <div className="container sec1-center">
            <h1> Section 2 </h1>
          </div>{" "}
        </section> */}
